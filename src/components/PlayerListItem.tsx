...
export function PlayerListItem({ player, isOrganizer, isPaid, showPhone, onTogglePayment }: PlayerListItemProps) {
      ...
      <div className="flex-1 min-w-0">
        ...
        {showPhone && player.phone && (
          <div className="flex items-center gap-1.5 mt-1">
            <span className="text-xs text-muted-foreground">{formatPhone(player.phone)}</span>
            <a
